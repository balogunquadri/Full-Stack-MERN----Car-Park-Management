...
router.post(
  ...
  [
    ...
    [
      check("name", "Please provide the name")
        .not()
        .isEmpty(),
      check("phone", "Please provide the phone")
        .not()
        .isEmpty(),
      check("platenumber", "Please provide the plate number")
        .not()
        .isEmpty(),
      check("model", "Please provide the model")
        .not()
        .isEmpty()
    ]
  ],
  async (req, res) => {
    ...
    const { name, phone, platenumber, model, vehtype, isconfirmed } = req.body;
...
router.put("/:id", auth, async (req, res) => {
  ...
  // build Guest object
  const guestFields = { name, phone, platenumber, model, vehtype, isconfirmed };
